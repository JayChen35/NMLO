...
def train_mnist(num_layers: int):
    ...
    total_time = 0
    training_set, testing_set = create_training_set("mnist_train.csv"), create_training_set("mnist_test.csv")
    for epoch in range(1, NUM_EPOCHS+1):
        start = time.perf_counter()
        w_list, b_list = back_propagation(w_list, b_list, training_set, LAMBDA)
